 ...
 * - -1  失败
 */
extern int send_recv_msgo( int sockfd , struct sockaddr *pservaddr , char *datamsg, int datalen ,int sec , int usec );
 ...
 * - -1  失败
 */
extern int gethostwithfd_r_o(int sockfd , struct sockaddr *servaddr ,char *domain, char *ip , int sec , int usec);
