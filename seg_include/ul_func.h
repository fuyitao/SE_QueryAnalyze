...
# ifndef __UL_FUNCLIB_H__
# define __UL_FUNCLIB_H__
...
/*
 * NOTICE : The functions defined in this file are packaged system function.
 *        : man the function name removed "ul_" prefix for defail
 */
...
//**********************************************************************
extern void  * ul_calloc(size_t n, size_t size);

//*******************************************
// allocates size bytes and returns a pointer to the allocated memory.The memory
// is not cleared.
// wrap include the LOG function,and the memory will be set to zero
//*******************************************
extern void * ul_malloc(size_t size);
...
//*********************************************
extern void    *ul_realloc(void *ptr, size_t size);
...
//***************************************************
extern int ul_open(const char *pathname, int oflag, mode_t mode);
...
//************************************************
int ul_write(int fd, void *ptr, size_t nbytes);
...
//***********************************************
int ul_fchown(int fildes, gid_t group);
...
//*******************************************************************
int ul_shmget(key_t key, int size, int shmflg);
...
//*******************************************************************
int ul_msgsnd ( int msqid, struct msgbuf *msgp, int msgsz, int msgflg );

//*******************************************************************
//  Wrap function about msgrcv()
//*******************************************************************
int ul_msgrcv ( int msqid, struct msgbuf *msgp, int msgsz, long msgtyp, int msgflg );
